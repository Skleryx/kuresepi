    ...
    return (
        <div className="min-h-screen pt-24 pb-12 px-6 flex items-center justify-center">
            <div className="w-full max-w-md bg-bg-secondary/80 backdrop-blur-cyber rounded-2xl border border-border-glow p-8 shadow-card">
                <h2 className="text-3xl font-serif text-neon-green mb-6 text-center">Login to Kuresepi</h2>
                ...
                <p className="mt-6 text-center text-text-muted text-sm">
                    ...
                    <Link to="/register" className="text-neon-lime hover:text-white transition-colors">
                        Register here
                    </Link>
                </p>
            </div>
